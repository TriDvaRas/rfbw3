...
Command: npx gltfjsx@6.2.3 -T -t -o src/components/Three/Models/Column.tsx garbage/models/Column.glb
*/
...
export function Column(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/Column-transformed.glb') as GLTFResult
  return (
...
useGLTF.preload('/Column-transformed.glb')
