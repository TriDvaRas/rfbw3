          ...
          <div className="w-1/3 flex flex-col  items-center justify-center max-h-full">
            <div className="flex flex-col  items-center justify-center">
              <div className="w-[260px] h-[390px] relative mb-12 bg-slate-800 ">
                <Image src={getMovieValues().imageURL || '/errorAvatar.jpg'} layout="fill" alt="Ты не должен этого видеть. Перезалей картинку." width={300} height={450} className="object-cover rounded-lg" />
                ...
                <div className={`absolute overflow-clip left-[-25px] bottom-[-30px] w-[310px] h-[80px] rounded-full bg-opacity-100 bg-amber-500 px-1 py-1  flex text-center align-middle items-center justify-center text-slate-200 ${label.length > 7 ? label.length > 12 ? label.length > 15 ? `text-3xl` : `text-4xl` : `text-5xl` : `text-6xl`}`} >{label || 'ЯЙЦА'}</div >
              </div>
              <div className="flex flex-row gap-5 justify-center items-center" >
                <Avatar height={75} width={75} border imageClassName="ring-amber-600" src={imageURL || '/errorAvatar.jpg'} shape="circle" />
                <Avatar height={50} width={50} border imageClassName="ring-amber-600" src={imageURL || '/errorAvatar.jpg'} shape="circle" />
                <Avatar height={25} width={25} border imageClassName="ring-amber-600" src={imageURL || '/errorAvatar.jpg'} shape="circle" />
                <Avatar height={10} width={10} border imageClassName="ring-amber-600" src={imageURL || '/errorAvatar.jpg'} shape="circle" />
              </div>
              <Modal.Actions>
